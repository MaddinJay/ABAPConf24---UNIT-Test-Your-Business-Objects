CLASS zcl_generate_data_mj DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_data_mj IMPLEMENTATION.
  ...
  METHOD generate_ratings.
    ...
    INSERT zrating_mj FROM TABLE @ratings.
  ...
  METHOD generate_products.
    DATA products TYPE TABLE OF zproduct_mj.
    DELETE FROM zproduct_mj.
    ...
    INSERT zproduct_mj FROM TABLE @products.
    r_number_of_entries = sy-dbcnt.
  ENDMETHOD.
ENDCLASS.
